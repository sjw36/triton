...
struct GPULoadOpConversion
    : public ConvertTritonGPUOpToLLVMPattern<triton::gpu::LoadOp>,
      public LoadStoreConversionBase {
  using ConvertTritonGPUOpToLLVMPattern<
      triton::gpu::LoadOp>::ConvertTritonGPUOpToLLVMPattern;

  GPULoadOpConversion(TritonGPUToLLVMTypeConverter &converter,
                      ModuleAxisInfoAnalysis &axisAnalysisPass,
                      PatternBenefit benefit)
      : ConvertTritonGPUOpToLLVMPattern<triton::gpu::LoadOp>(converter, benefit),
        LoadStoreConversionBase(axisAnalysisPass) {}

  LogicalResult
  matchAndRewrite(triton::gpu::LoadOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
    auto loc = op->getLoc();
...
struct GPUStoreOpConversion
    : public ConvertTritonGPUOpToLLVMPattern<triton::gpu::StoreOp>,
      public LoadStoreConversionBase {
  using ConvertTritonGPUOpToLLVMPattern<
      triton::gpu::StoreOp>::ConvertTritonGPUOpToLLVMPattern;

  GPUStoreOpConversion(TritonGPUToLLVMTypeConverter &converter,
                       ModuleAxisInfoAnalysis &axisAnalysisPass,
                       PatternBenefit benefit)
      : ConvertTritonGPUOpToLLVMPattern<triton::gpu::StoreOp>(converter, benefit),
        LoadStoreConversionBase(axisAnalysisPass) {}
...
void populateLoadStoreOpToLLVMPatterns(
  ...
  patterns.add<GPULoadOpConversion>(typeConverter, axisInfoAnalysis, benefit);
  patterns.add<GPUStoreOpConversion>(typeConverter, axisInfoAnalysis, benefit);
