...
void init_triton_passes_ttir(py::module &&m) {
  ...
  ADD_PASS_WRAPPER_0("add_decompose_tensor_descriptor_parameters",
                     createTritonDecomposeTensorDescriptorParameters);
  ADD_PASS_OPTION_WRAPPER_1("add_rewrite_tensor_descriptor_to_pointer",
                            createTritonRewriteTensorDescriptorToPointer, bool);
