...
module attributes {"ttg.num-warps" = 4 : i32} {
  tt.func @make_tensor_descriptor(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %n: i32 {tt.divisibility = 16 : i32}) -> !tt.tensordesc<16xf32> {
    %c1_i64 = arith.constant 1 : i64
    %c1_i32 = arith.constant 1 : i32
    %ptr = tt.addptr %arg0, %c1_i32 : !tt.ptr<f32>, i32
    %desc = tt.make_tensor_descriptor %ptr, [%n], [%c1_i64] : !tt.ptr<f32>, !tt.tensordesc<16xf32>
    tt.return %desc : !tt.tensordesc<16xf32>
  }
}

// CHECK-LABEL:   tt.func @make_tensor_descriptor(
// CHECK-SAME:  %[[VAL_0:.*]]: !tt.ptr<f32> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %[[VAL_1:.*]]: i32 {tt.divisibility = 16 : i32}) -> !tt.tensordesc<16xf32> {
