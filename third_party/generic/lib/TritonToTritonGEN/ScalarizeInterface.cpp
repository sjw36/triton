#include "generic/include/ScalarizePass/ScalarizeInterfaceImpl.h"
...
#include "generic/include/ScalarizePass/ScalarizeInterface.cpp.inc"

using namespace mlir::triton;
using namespace mlir::triton::gen;

Value mlir::triton::gen::computeScalarValue(Operation *scalarizationOp,
                                            Value vals,
...
bool mlir::triton::gen::canComputeScalarValue(Value vals) {
...
void mlir::triton::gen::registerTritonOpScalarizeExternalModels(
