...
public:
  explicit DotConversionTarget(MLIRContext &ctx) : ConversionTarget(ctx) {
    ...
    addIllegalOp<gen::DotOp>();
  }
};

struct DotOpConversion : public OpConversionPattern<gen::DotOp> {
  using OpConversionPattern::OpConversionPattern;

  LogicalResult
  matchAndRewrite(gen::DotOp op, OpAdaptor adaptor,
...
struct ConvertDotGeneric
    : public triton::gen::impl::ConvertDotGenericBase<ConvertDotGeneric> {
