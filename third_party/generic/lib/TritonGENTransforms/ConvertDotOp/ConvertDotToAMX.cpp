...
Value getResValueForLoopCarriedAcc(gen::DotOp op) {
...
bool isAmxCandidate(gen::DotOp op, bool supportInt8, bool supportFp16,
                    bool supportBf16, AmxDotOpCandidate &candidate) {
...
struct ConvertDotToAMX
    : public triton::gen::impl::ConvertDotToAMXBase<ConvertDotToAMX> {
  ...
  void runOnOperation() override {
    ...
    mod->walk([this, &candidates](gen::DotOp op) {
      AmxDotOpCandidate candidate;
