...
#include "generic/include/TritonGENTransforms/Passes.h"
...
#include "generic/include/TritonGENTransforms/Passes.h.inc"
} // namespace gen
} // namespace triton
} // namespace mlir
...
bool isUkernelsCandidate(triton::gen::DotOp op, DotOpCandidate &candidate,
                         Ukernels ukernel) {
...
extractBufferFromBlockPtr(Value blockPtr, triton::gen::DotOp &dotOp,
...
convertCandidate(DotOpCandidate &candidate, Ukernels ukernels,
                 ...
                 PatternRewriter &rewriter) {
  triton::gen::DotOp op = candidate.op;
  ...
  Value brgemm = rewriter.create<triton::gen::BrgemmCreate>(
  ...
  rewriter.create<triton::gen::BrgemmExecute>(
...
struct ConvertDotOpToUkernelOps
    : public triton::gen::impl::ConvertDotOpToUkernelOpsBase<
  ...
  void runOnOperation() override {
    ...
    mod->walk([&candidates, this](triton::gen::DotOp op) {
      DotOpCandidate candidate;
