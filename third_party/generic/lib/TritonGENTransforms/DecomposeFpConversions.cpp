...
Value convertFp16ToFp8E4M3Rtz(Location loc, Value src,
                              PatternRewriter &rewriter) {
  return convertToFp8(loc, src, rewriter.getType<mlir::Float8E4M3FNType>(), 4,
                      7, false, false, rewriter);
}

Value convertFp16ToFp8E4M3Rtne(Location loc, Value src,
                               PatternRewriter &rewriter) {
  return convertToFp8(loc, src, rewriter.getType<mlir::Float8E4M3FNType>(), 4,
                      7, true, false, rewriter);
}
...
Value convertFp32ToFp8E5M2Rtz(Location loc, Value src,
                              PatternRewriter &rewriter) {
  return convertToFp8(loc, src, rewriter.getType<mlir::Float8E5M2Type>(), 5, 15,
...
Value convertFp32ToFp8E5M2B16Rtz(Location loc, Value src,
                                 PatternRewriter &rewriter) {
  return convertToFp8(loc, src, rewriter.getType<mlir::Float8E5M2FNUZType>(), 5,
                      16, false, true, rewriter);
}

Value convertFp32ToFp8E5M2B16Rtne(Location loc, Value src,
                                  PatternRewriter &rewriter) {
  return convertToFp8(loc, src, rewriter.getType<mlir::Float8E5M2FNUZType>(), 5,
                      16, true, true, rewriter);
}
...
struct DecomposeFpConversions
    : public triton::gen::impl::DecomposeFpConversionsBase<
