...
TritonGENToLLVMTypeConverter::TritonGENToLLVMTypeConverter(
...
Type TritonGENToLLVMTypeConverter::convertTritonPointerType(
...
Type TritonGENToLLVMTypeConverter::convertTritonTensorType(
